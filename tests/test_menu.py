...
class TestMenu(unittest.TestCase):
    """Test Menu behaviors including user prompts,
    game creation, and high scores."""
    ...
    def test_prompt_difficulty_invalid_then_valid_prints_warning(self):
        ...
        out = io.StringIO()
        with (
            patch("builtins.input", side_effect=["crazy", "medium"]),
            patch("sys.stdout", new=out),
        ):
    ...
    def test_prompt_name_whitespace_then_default_used(self):
