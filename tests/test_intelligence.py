...
class TestIntelligence(unittest.TestCase):
    ...
    def test_decide_hold_if_reaches_100(self):
        ...
        self.assertEqual(
            self.ai.decide(turn_total=50, my_score=60, opponent_score=20), "hold"
        )
    ...
    def test_easy_decision(self):
        ...
        self.assertEqual(
            self.ai.decide(turn_total=16, my_score=10, opponent_score=10), "hold"
        )
        self.assertEqual(
            self.ai.decide(turn_total=10, my_score=10, opponent_score=10), "roll"
        )
    ...
    def test_medium_hold_threshold(self):
        ...
        self.assertEqual(
            self.ai.decide(turn_total=20, my_score=50, opponent_score=50), "hold"
        )
    ...
    def test_medium_opponent_close_to_winning(self):
        ...
        self.ai.set_difficulty("medium")
        self.assertEqual(
            self.ai.decide(turn_total=17, my_score=50, opponent_score=90), "roll"
        )
        self.assertEqual(
            self.ai.decide(turn_total=18, my_score=50, opponent_score=90), "hold"
        )
    ...
    def test_hard_decision_basic(self):
        ...
        self.assertEqual(
            self.ai.decide(turn_total=5, my_score=50, opponent_score=50), "roll"
        )
        self.assertEqual(
            self.ai.decide(turn_total=30, my_score=50, opponent_score=50), "hold"
        )
    ...
    def test_hard_decision_score_gap_adjustment(self):
        ...
        self.ai.set_difficulty("hard")
        self.assertEqual(
            self.ai.decide(turn_total=20, my_score=50, opponent_score=70), "roll"
        )
        self.assertEqual(
            self.ai.decide(turn_total=20, my_score=70, opponent_score=50), "hold"
        )
    ...
    def test_hard_decision_opponent_near_win(self):
        ...
        self.ai.set_difficulty("hard")
        self.assertEqual(
            self.ai.decide(turn_total=10, my_score=50, opponent_score=92), "hold"
        )
