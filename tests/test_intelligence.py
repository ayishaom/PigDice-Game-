"""Unit tests for Intelligence class: verify AI decision-making for Pig game."""
...
class TestIntelligence(unittest.TestCase):
    ...
    def test_easy_decision(self):
        """Decide whether to roll or hold on easy difficulty based on threshold."""
    ...
    def test_medium_opponent_close_to_winning(self):
        """Adjust medium difficulty decisions when opponent is close to winning."""
        self.ai.set_difficulty("medium")
    ...
    def test_hard_decision_basic(self):
        """Decide whether to roll or hold on hard difficulty using threshold."""
    ...
    def test_hard_decision_score_gap_adjustment(self):
        """Adjust hard difficulty decisions based on score difference with opponent."""
        self.ai.set_difficulty("hard")
